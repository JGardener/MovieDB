      ...
      <div className={styles.wrapperFull}>
        <div className={styles.movieInfoFull}>
          ...
          <ul className={styles.infoListFull}>
            ...
            {props.imdbRating && (
              <li className={styles.imdbRating}>
                Rating: <br />
                {props.imdbRating}
              </li>
            )}
          ...
          <div className={styles.buttonContainer}>
            <button className={styles.cardButton} onClick={addToList}>
              Add to Favourites
            </button>
            <button className={styles.cardButton} onClick={removeFromList}>
              Remove from Favourites
            </button>
            <button className={styles.cardButton}>
              <a href={`https://www.imdb.com/title/${props.id}/`}>Go to iMDB</a>
            </button>

            <button className={styles.cardButton}>
              <Link to="/moviedb">Back to Home</Link>
            </button>
          </div>
        </div>
        <div className={styles.movieImageFullContainer}>
          {props.poster === "N/A" ? (
            <img
              className={styles.movieImageFull}
              src={NA}
              alt="No movie poster available"
            />
          ) : (
            <img
              className={styles.movieImageFull}
    ...
    return (
      <div className={styles.wrapper}>
        <div className={styles.movieImage}>
          {props.poster === "N/A" ? (
            <img
              className={styles.movieImageSearch}
              src={NA}
              alt="No movie poster available"
            />
          ) : (
        ...
        <div className={styles.movieInfo}>
          ...
          {props.director === "N/A" || !props.director ? (
            ""
          ) : (
            <p className={styles.director}>Director: {props.director}</p>
          )}
